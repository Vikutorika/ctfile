			var REFERRER_BLACKLIST = ['https://www.qvocd.cc/', 'https://funletu.com/'];
			        if (REFERRER_BLACKLIST.includes(document.referrer)) {
			            ...
			            document.location.href = "https://bili33.top";
			        };
			        const getInfo = async () => {
			        ...
			        const readClipboard = async () => {
			            ...
			            if (text) {
			                ...
			                try {
			                    ...
			                    mdui.alert('期望的文本形式类似于“https://url76.ctfile.com/f/20044976-553638227-3a47df 密码4718”，或者“https://url74.ctfile.com/f/26012674-739221914-59608d?p=6195”请尝试重新复制或者手动填入', '无法从剪贴板读取链接和密码');
			                }
			            }
			        }
